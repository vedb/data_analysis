...
def show_world_v01(
    ...
    if os.path.exists(reference_file):
        ...
        for k in dat.keys():
            reference_arrays[k] = dat[k]
        reference_list = gaze_utils.arraydict_to_dictlist(reference_arrays)
    else:
        raise ValueError("No valid reference file was found!", reference_file)
    ...
    for i in range(start_index, end_index):
        ...
        img = cv2.circle(img, (gaze_pixel_x, gaze_pixel_y), 6, (25, 255, 0), 3)
