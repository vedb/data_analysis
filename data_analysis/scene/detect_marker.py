...
fourcc = "XVID"
out = cv2.VideoWriter(
    "marker_detection_output.avi", cv2.VideoWriter_fourcc(*fourcc), 30, size
)
...
my_dict = {
    "marker_x": np.array(marker_x),
    "marker_y": np.array(marker_y),
    "marker_size": np.array(marker_size),
    "marker_index": np.array(marker_index),
}
